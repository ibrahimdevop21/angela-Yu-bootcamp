...
app.post("/submit", (req, res) => {
  ...
  const randomAdj = adj[Math.floor(Math.random() * adjLength + 1)];
  const randomNoun = noun[Math.floor(Math.random() * nounLength + 1)];

  const generatedName = `${randomAdj} ${randomNoun}`
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", { result: generatedName });
